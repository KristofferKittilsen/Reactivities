...
const Activities = {
    ...
    create: (activity: IActivityFormValues) => requests.post<void>("/activities", activity),
    update: (activity: IActivityFormValues) => requests.put<void>(`/activities/${activity.id}`, activity),
